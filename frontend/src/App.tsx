...
export const App: React.FC = () => {
  return (
    <BrowserRouter>
      <Toaster position="top-right" toastOptions={{ style: { background: '#0D111E', color: '#fff', border: '1px solid #1E293B' } }} />
      <Routes>
        {/* Auth Routes */}
        ...
        <Route path="/student" element={
          ...
          <Route path="exams/:id/compatibility" element={<CompatibilityCheck />} />
          <Route path="exams/:id/confirmation" element={<SubmissionConfirmation />} />
          <Route index element={<Navigate to="exams" replace />} />
        </Route>

        {/* Special standalone route for exam terminal to prevent navigation distraction */}
        <Route path="/student/exams/:id/terminal" element={
          <RequireAuth allowedRole="STUDENT">
            <ExamTerminal />
          </RequireAuth>
        } />
