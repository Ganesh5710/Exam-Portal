    ...
    <div className="flex h-screen overflow-hidden bg-background text-foreground transition-colors duration-200">
      ...
      <div className="md:hidden flex items-center justify-between w-full h-16 px-4 border-b border-border bg-card fixed top-0 left-0 z-40">
        <div className="flex items-center gap-2">
          <span className="text-xl font-bold bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text text-transparent">SecureExam</span>
        </div>
      ...
      `}>
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-border">
          ...
          {collapsed && (
            <span className="text-xl font-bold text-violet-500 mx-auto">🛡️</span>
          )}
          <button
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div className="overflow-hidden">
                ...
                <span className="text-xs text-violet-400 capitalize">{user?.role.toLowerCase()}</span>
              </div>
            )}
          </div>
        </div>
