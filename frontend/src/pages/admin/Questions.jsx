  ...
  const handleSaveAIQuestions = async () => {
    ...
    try {
      const formatted = aiPreviewQuestions.map(q => ({
        ...
        score: Number(q.score) || 4.0,
        negativeMarks: Number(q.negativeMarks) || 1.0,
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const body = {
        ...
        score: parseFloat(formData.score) || 4.0,
        negativeMarks: parseFloat(formData.negativeMarks) || 1.0,
