      ...
      {filtered.length > 0 && (
        <div className="glass-card rounded-xl border border-slate-800/60 overflow-hidden">
              ...
              <tbody className="divide-y divide-slate-800/50">
                {filtered.map((subject) => (
                  ...
                  >
                    ...
                    {/* Course */}
                    <td className="px-6 py-4 text-slate-300">{subject.course}</td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-300">{subject.department.name}</span>
          ...
          <div className="px-6 py-3 border-t border-slate-800 text-xs text-muted-foreground flex items-center justify-between">
            <span>
              Showing <span className="font-semibold text-slate-300">{filtered.length}</span>{' '}
              of <span className="font-semibold text-slate-300">{subjects.length}</span> subjects
            </span>
            {(search || deptFilter) && (
              <button
                onClick={() => {
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={form.semester}
                    onChange={(e) =>
                      setForm({ ...form, semester: parseInt(e.target.value) || 1 })
                    }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-md mx-4 bg-slate-950 border border-slate-800 rounded-2xl shadow-2xl shadow-black/40 p-6 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
              ...
              This action cannot be undone and may affect associated exams and questions.
            </p>
